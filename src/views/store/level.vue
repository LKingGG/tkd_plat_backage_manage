<template>
  <div>
    <div class="mt-10 overflow">
      <el-input size="small" placeholder="请输入等级名称" class="w-150 mr-10"></el-input>
      <el-button size="small" @click="dialogVisible = true">搜索</el-button>
      <div class="f-r">
        <el-button size="small" @click="dialogVisible = true" type="primary" class="el-icon-plus"> 添加店铺等级</el-button>
      </div>
    </div>
    <div>
      <el-table
